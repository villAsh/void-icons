...
const ChartColumnDecreasing = ({
  ...
  return (
    <motion.svg
      ...
      className={cn("lucide lucide-chart-column-decreasing", className)}
      width={size ?? width ?? 24}
    ...
    >
      ...
      <motion.path variants={column3Variants} d="M18 17v-3" />
      <path d="M3 3v16a2 2 0 0 0 2 2h16" />
      <motion.path variants={column1Variants} d="M8 17V5" />
    </motion.svg>
  );
};
